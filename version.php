...
$plugin->component = 'local_attendance'; // Full name of the plugin (used for diagnostics): plugintype_pluginname
...
$plugin->release = 'v1.3.3'; //Optional - Human-readable version name
?>